...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    if official_count > 0 and page == 1:
        c.print(f"[bright_cyan]★ {official_count} official optional skill(s) from {BRAND_NAME}[/]")
    c.print()
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    if not force:
        ...
        if bundle.source == "official":
            c.print(Panel(
                f"[bold bright_cyan]This is an official optional skill maintained by {BRAND_NAME}.[/]\n\n"
